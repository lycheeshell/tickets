                    ...
                    <form class="form-horizontal form-material" id="loginform">
                        ...
                        <div class="form-group m-b-0">
                            <div class="col-sm-12 text-center">
                                                        还没有账号？ <a href="<%=path%>/user/register.jsp" class="text-info m-l-5"><b>注册</b></a>
                            </div>
                        </div>
                        <br/>
                        <div class="form-group m-b-0">
    	...
    	function login() {
	        ...
	        $.ajax({
	            ...
	            success: function (backData) {
					...
					if (backData.account==account && backData.password==password) {
	                	window.location.href = path + "/user/index.jsp?id=" + backData.id;
	                } else {
	                	alert("账号或密码错误");
	                }
	            },
