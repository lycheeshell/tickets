            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">场馆主页</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                        <button type="button" class="btn btn-info d-none d-lg-block m-l-15" id="modifyVenue">修改场馆信息</button>
                        </div>
                    </div>
                </div>
                <!-- ============================================================== -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <a href="<%=path%>/venue/releaseShow.jsp?id=<%=id%>&name=<%=name%>" class="btn btn-primary">发布演出</a>
                                    </div>
                                </div>
                                <!-- Card -->
                            </div>
                            ...
                            <div class="col-lg-3 col-md-6">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <a href="<%=path%>/venue/sellTicket.jsp?id=<%=id%>&name=<%=name%>" class="btn btn-primary">现场售票</a>
                                    </div>
                                </div>
                                <!-- Card -->
                            </div>
                            ...
                            <div class="col-lg-3 col-md-6 img-responsive">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <a href="<%=path%>/venue/checkTicket.jsp?id=<%=id%>&name=<%=name%>" class="btn btn-primary">检票登记</a>
                                    </div>
                                </div>
                                <!-- Card -->
                            </div>
                            ...
                            <div class="col-lg-3 col-md-6">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <a href="<%=path%>/venue/showStatistics.jsp?id=<%=id%>&name=<%=name%>" class="btn btn-primary">查看场馆统计信息</a>
                                    </div>
                                </div>
                                <!-- Card -->
                            </div>
