                    ...
                    <form class="form-horizontal form-material" id="loginform">
                        ...
                        <div class="form-group m-b-0">
                            <div class="col-sm-12 text-center">
                                                        还没有账号？ <a href="<%=path%>/venue/register.jsp" class="text-info m-l-5"><b>注册</b></a>
                            </div>
                        </div>
                        <br/>
                        <div class="form-group m-b-0">
                        ...
                        <div class="form-group m-b-0">
                            <div class="col-sm-12 text-center">
                                                        经理用户请点击 <a href="<%=path%>/manager/login.jsp" class="text-info m-l-5"><b>这里</b></a>&nbsp;&nbsp;&nbsp;登录
                            </div>
                        </div>
                    </form>
                </div>
    	...
    	function login() {
	        ...
	        $.ajax({
	            ...
	            success: function (backData) {
	                ...
	                if(backData.state == 0 || backData.state == 2) {
	                	alert("申请审核暂未通过");
	                } else if (backData.account==account && backData.password==password) {
	                	window.location.href = path + "/venue/index.jsp?id=" + backData.id + "&name=" + backData.name;
	                } else {
	                	alert("账号或密码错误");
	                }
	            },
